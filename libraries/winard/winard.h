...
//# define CFBG          97
# define COLOR11       98 
//# define CPIND         98   // indicator pressed    color11
//# define CIND          98   // indicator
# define COLOR12       99 
# define CSELECTED     99 
//# define CSIND         99   // indicator selected   color12
//# define CHBG          99
# define COLOR13      100 
# define CHL          100  // highlightcolor
//# define C!SIND       100   // indicator !selected  color13
//# define CSEL         100
# define COLOR14      101 
...
# define STYLE        106
//# define THEMEPART    107
# define THEMESTYLE   107
//# define WIDGETTHEME  107
# define MAP          108
# define THEME        109
...
String str1;
char   str2[64], str3[64];  // str3, nog nodig?
...
{ int a=0, len;
  ...
  { tx_str(0,"Start");
    ...
    { case 1: sscanf(str2,"%d%d%d%d",&Bag.i1,&Bag.i2,&Bag.i3,&Bag.i4);break;
      case 2:
      case 3: sscanf(str2,"%d%d%d%s",&Bag.i1,&Bag.i2,&Bag.i3,&Bag.str);break;   
    }   
//    tx_str(TEXT,Bag.str);
  }
}
